...
export default function Section1BreadCrumb() {
  return (
    <>
      <Box
        sx={{
        ...
        <Carousel>
          ...
          >
            ...
            >
              ...
              <Stack direction={'row'} elevation={3} sx={{ width: "50%", height: "3rem",backgroundColor:'#1976d2',justifyContent:'center',alignItems:'center' }}>
